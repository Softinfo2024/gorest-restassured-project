...
public class UserExtractionTest extends TestBase {
    ...
    //10. Get email of the object where name = Rahul Iyengar
    @Test
    public void test010() {
        String email = response.extract().path("find{it.name == 'Rahul Iyengar'}.email");
        System.out.println("------------------StartingTest---------------------------");
        System.out.println("The email of the object where name Chandini Khatri is: " + email);
        System.out.println("------------------End of Test---------------------------");
    }

    //11. Get gender of id = 5914050
    @Test
    public void test011() {
        String gender = response.extract().path("find{it.id == 5914050 }.gender");
        System.out.println("------------------StartingTest---------------------------");
