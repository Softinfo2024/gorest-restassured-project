...
public class PostsExtractionTest extends TestBase {
    ...
    @Test
    public void test006() {
        List<String> titleOfUserId = response.extract().path("findAll{it.user_id = 5914051}.title");
        System.out.println("------------------StartingTest---------------------------");
        System.out.println("The title of all records whose user_id = 5914200 : " + titleOfUserId);
        System.out.println("------------------End of Test---------------------------");
    }

    //7. Extract the body of all records whose id = 93944
    @Test
    public void test007() {
        List<String> allBodyRecords = response.extract().path("findAll{it.id = 93944}.body");
        System.out.println("------------------StartingTest---------------------------");
